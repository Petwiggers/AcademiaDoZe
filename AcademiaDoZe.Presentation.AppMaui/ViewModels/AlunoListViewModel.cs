...
namespace AcademiaDoZe.Presentation.AppMaui.ViewModels
{
    public partial class AlunoListViewModel : BaseViewModel
    {
        ...
        private AlunoDTO? _selectedColaborador;
        public AlunoDTO? SelectedColaborador
        {
        ...
        private async Task LoadAlunosAsync()
        {
            ...
            try
            {
                ...
                var colaboradoresList = await _alunoService.ObterTodosAsync();
                if (colaboradoresList != null)
                {
                    ...
                    {
                        foreach (var aluno in colaboradoresList)
                        {
                            Alunos.Add(aluno);
                        }
                        OnPropertyChanged(nameof(Alunos));
